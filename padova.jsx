        ...
        {sel ? (
          <div style={{ padding: "0 20px 16px" }}>
            ...
            <div style={{ display: "flex", gap: 10, marginTop: 14 }}>
              <button onClick={() => go("place", window.PLACES.find(p => p.id === sel.id) || sel)}
...
// Shared map background — used by Padova tab AND itinerary
function MapBg({ pins = [], path = null, selected, onPin, userPin, numbered = false }) {
  return (
    <div style={{
...
Object.assign(window, { Padova, MapBg });
